...
|                      | [Client](http://arduino.cc/en/Reference/ClientConstructor)            |
|                      | interface should should work with the libraries. Components           |
|                      | that implement the interface include the                              |
|                      | [Ethernet Shield](http://arduino.cc/en/Main/ArduinoEthernetShield)    |
|                      | and [WiFi Shield](http://arduino.cc/en/Main/ArduinoWiFiShield_.       |
|----------------------|-----------------------------------------------------------------------|
...
|                      | [starter kits](http://arduino.cc/en/Main/ArduinoStarterKit)           |
